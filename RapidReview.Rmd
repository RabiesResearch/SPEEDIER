...
for(i in 1:nrow(rr_summary)){
  if(!is.na(rr_summary$Doc_name[i])){
    rr_summary$Title2[i] <- paste0("<a href='output/rapid_review/", rr_summary$Doc_name[i], "', target='blank'>", 
...
rr_summary <- select(rr_summary, Title2, Strengths, Limitations, Responses.Feedback)
...
The table below provides a review of documents and literature, with strengths and limitations highlighted alongside the relevant responses and feedback for SPEEDIER/FETPAFI staff. A full version of the table can be downloaded `r PHL_embed_file(filename="rapid_review/RapidReview", filetype="xlsx", label="here")`.  
<br>
